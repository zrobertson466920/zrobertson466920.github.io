# TVD-MI and Item-Response Theory

We'll review total variation distance (TVD) and mutual information (MI) and how it can be connected with the Rasch model in item response theory (IRT) using the principle of maximum entropy. We then validate assumptions and show how it can reduce the sampling requirements to estimate TVD-MI. 
